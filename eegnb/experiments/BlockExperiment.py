...
class BlockExperiment(BaseExperiment, ABC):
    ...
    def __init__(self, exp_name, block_duration, eeg, save_fn, block_trial_size, n_blocks, iti: float, soa: float, jitter: float,
                 use_vr=False, use_fullscr=True, stereoscopic=False, expected_refresh_rate=None):
        ...
        super().__init__(exp_name, block_duration, eeg, save_fn, total_trials, iti, soa, jitter, use_vr, use_fullscr, stereoscopic=stereoscopic, expected_refresh_rate=expected_refresh_rate)
